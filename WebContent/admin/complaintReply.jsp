			                  ...
			                  <table id="dataList" class="table table-bordered table-striped table-hover dataTable">
			                      <thead>
			                          <tr>
										  ...
										  <th class="sorting_asc">所在帖子标题</th>
			                      ...
			                      <tbody>
			                        <c:forEach items="${Commlist}" var="pro">
			                      		<tr>       
		                                  ...
		                                  <td class="text-center">                                           
		                                 	  <button type="button" class="btn bg-olive btn-xs" data-toggle="modal" data-target="#editModal" onclick="showBeName('${pro.bename.username}','${pro.id}')">处理</button>                                           
		                                  	  <button type="button" class="btn bg-olive btn-xs" data-toggle="modal" data-target="#info" onclick="show('${pro.rid.info}')">正文</button>                                           
		                                  </td>
			                          </tr>
			                          </c:forEach>
			                      </tbody>
